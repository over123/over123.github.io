 ...
 * @LastEditors: xudan
 * @LastEditTime: 2024-10-16 17:09:45
 * @Description: 
  ...
  <el-collapse v-model="activeIndex" accordion class="collapse_container">
    ...
    >
      <template #title class="collapse-title_container">
        {{ project.company }}
        <el-button type="primary" @click.stop="openDrawer(project)"
          >Edit</el-button
        >
        <el-button type="danger" @click.stop="deleteProject(project._id || '')"
          >Delete</el-button
        >
      </template>
      <el-descriptions class="project-card_container">
        <el-descriptions-item
          >{{ project.startTime }} - {{ project.endTime }}</el-descriptions-item
        >
