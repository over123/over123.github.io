 ...
 * @LastEditors: xudan
 * @LastEditTime: 2024-08-09 18:32:20
 * @Description: 
    ...
    <div>
        ...
        <el-form :model="experienceOne" label-width="auto" style="max-width: 600px">
            <el-form-item label="Activity name">
                <el-input v-model="experienceOne.company" placeholder="please input your company" />
            </el-form-item>
            <el-form-item label="Activity time">
                <div class="experience-form__content">
                    <div>
                        <el-date-picker v-model="experienceOne.startTime" format="YYYY/MM" value-format="YYYY/MM" type="month" placeholder="Pick a month" />
                    </div>
                        
                    <div class="text-gray-500"> | </div>
    
                    <div>
                        <el-date-picker v-model="experienceOne.endTime" format="YYYY/MM" value-format="YYYY/MM" type="month" placeholder="Pick a month" />
                    </div>
                </div>
